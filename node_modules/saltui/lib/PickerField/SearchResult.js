    ...
    value: function renderResultItem(item, index) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'span',
          { className: _Context2.default.prefixClass('picker-field-search-result-item-entry picker-field-right-icon') },
          t.props.formatter(item)
        ),
        _react2.default.createElement(
          'span',
          { className: _Context2.default.prefixClass('picker-field-search-result-item-icon picker-field-right-icon') },
          iconHTML
        )
      );
    }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: _Context2.default.prefixClass('picker-field-searchpanel-head-bar') },
            _react2.default.createElement(
              'div',
              { className: _Context2.default.prefixClass('picker-field-searchpanel-head-bar-total') },
              _i18n2.default[locale].selected(length)
            ),
            _react2.default.createElement(
              'div',
              {
                className: _Context2.default.prefixClass('picker-field-searchpanel-head-bar-button'),
