  ...
  _createClass(CascadePanel, [{
    ...
    value: function showToast() {
      ...
      _Toast2.default.show({
        className: (0, _Context.prefixClass)('day-calendar-cascade-tip'),
        content: content
      });
    }
  }, {
    ...
    value: function processValue(propValue) {
      ...
      if (Object.prototype.toString.call(propValue) === '[object Object]') {
        var result = (0, _util.adaptCascadeDate)(propValue.startDate, propValue.endDate);
        value = {
          startDate: result.startDate,
          endDate: result.endDate
        };
      } else if (Object.prototype.toString.call(propValue) === '[object Array]') {
        var _result = (0, _util.adaptCascadeDate)(propValue[0], propValue[1] || propValue[0]);
        value = {
    ...
    value: function onDaySelected(timestamp) {
      var t = this;
      t.isASC = true;
      var _t$state$value = t.state.value,
          startDate = _t$state$value.startDate,
          endDate = _t$state$value.endDate,
          startDateType = _t$state$value.startDateType,
          endDateType = _t$state$value.endDateType;
    ...
    value: function renderHalfDay() {
      ...
      var full = _react2.default.createElement(
        'li',
        {
          className: (0, _classnames2.default)((0, _Context.prefixClass)('tap'), 'day-type-item full', {
      ...
      var am = _react2.default.createElement(
        'li',
        {
          className: (0, _classnames2.default)((0, _Context.prefixClass)('tap'), 'day-type-item am', {
      ...
      var pm = _react2.default.createElement(
        'li',
        {
          className: (0, _classnames2.default)((0, _Context.prefixClass)('tap'), 'day-type-item pm', {
      ...
      return _react2.default.createElement(
        'div',
        {
          className: (0, _Context.prefixClass)('day-calendar-half-day-wrapper')
        },
        _react2.default.createElement(
          'div',
          {
            className: (0, _Context.prefixClass)('day-calendar-half-day-container')
          },
          _react2.default.createElement(
            'ul',
