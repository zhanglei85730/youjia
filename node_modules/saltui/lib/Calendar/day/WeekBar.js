  ...
  _createClass(WeekBar, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        {
          className: (0, _classnames3.default)((0, _Context.prefixClass)('day-calendar-week-bar FBH'), _defineProperty({}, t.props.className, !!t.props.className))
        },
        t.locale.weekTitle.map(function (item, index) {
          return _react2.default.createElement(
            'div',
            {
              className: (0, _classnames3.default)((0, _Context.prefixClass)('FB1 FBAC'), 'week-bar-item', {
                first: index === 0,
                last: index === 6
              }),
              key: index
...
WeekBar.propTypes = {
  className: _propTypes2.default.string, // 国际化语言
