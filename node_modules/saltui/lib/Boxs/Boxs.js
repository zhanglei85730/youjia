...
var CENTER = 'center';
var END = 'end';
var ALIGN_VALUES = function ALIGN_VALUES() {
...
HBox.propTypes = {
  ...
  hAlign: _propTypes2.default.oneOf(ALIGN_VALUES()),
  vAlign: _propTypes2.default.oneOf(ALIGN_VALUES()),
...
exports.default = {
  HBox: HBox, VBox: VBox, Box: Box, ALIGN_VALUES: ALIGN_VALUES
};
