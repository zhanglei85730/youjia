  ...
  _createClass(PasswordInput, [{
    ...
    value: function renderPlaceHolder() {
      return _react2.default.createElement(
        'div',
        {
          className: (0, _classnames5.default)((0, _Context.prefixClass)('omit password-input-placeholder'), _defineProperty({}, (0, _Context.prefixClass)('DN'), this.props.value !== ''))
        },
    ...
    value: function renderInput() {
      ...
      return _react2.default.createElement('input', {
        ...
        type: type,
        value: inputValue,
        className: (0, _classnames5.default)((0, _Context.prefixClass)('password-input-text'), _defineProperty({}, (0, _Context.prefixClass)('password-input-text-decrypted'), this.props.decrypted)),
    ...
    value: function renderEyeIcon() {
      ...
      return _react2.default.createElement(EyeIcon, {
        className: (0, _classnames5.default)((0, _Context.prefixClass)('password-input-right-icon')),
        width: iconSize,
        height: iconSize,
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        {
          className: (0, _classnames5.default)((0, _Context.prefixClass)('password-input FBAC FBH'), _defineProperty({}, this.props.className, !!this.props.className))
        },
        !this.props.hideIcon ? _react2.default.createElement(_Lock2.default, {
          className: (0, _classnames5.default)((0, _Context.prefixClass)('password-input-left-icon')),
          width: iconSize,
          height: iconSize
        }) : null,
        _react2.default.createElement(
          'div',
          { className: (0, _classnames5.default)((0, _Context.prefixClass)('password-input-core')) },
...
PasswordInput.propTypes = {
  ...
  decrypted: _propTypes2.default.bool,
  onChange: _propTypes2.default.func,
  onDecryptedChange: _propTypes2.default.func,
