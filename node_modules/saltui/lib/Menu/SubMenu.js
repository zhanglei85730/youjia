  ...
  _createClass(Submenu, [{
    ...
    value: function onClickdMenu(e) {
      ...
      if (childrenLen > 0) {
        ...
        onClick({
          key: key, keyPath: keyPath, item: this, domEvent: e
        });
      }
    }
  }, {
...
Submenu.propTypes = {
  ...
  childrenLen: _propTypes2.default.number,
  pos: _propTypes2.default.string,
  level: _propTypes2.default.number,
  title: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number, _propTypes2.default.node]),
  multiple: _propTypes2.default.bool,
  disabled: _propTypes2.default.bool,
  isLastLeft: _propTypes2.default.bool,
  prefixCls: _propTypes2.default.string,
  onClick: _propTypes2.default.func,
  value: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number]),
  selectedKeys: _propTypes2.default.array,
  openKeys: _propTypes2.default.array,
  renderedData: _propTypes2.default.object,
  onSelect: _propTypes2.default.func,
  onDeselect: _propTypes2.default.func,
  target: _propTypes2.default.string,
  href: _propTypes2.default.string,
  expandPos: _propTypes2.default.array
};
