...
var TabBarItemTitle = function (_React$Component) {
  _inherits(TabBarItemTitle, _React$Component);
  ...
  _createClass(TabBarItemTitle, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'span',
        {
          className: _Context2.default.prefixClass('tabs-bar-item-label'),
...
TabBarItemTitle.propTypes = {
  ...
  activeTitleStyle: _propTypes2.default.object
};
TabBarItemTitle.defaultProps = {
  active: undefined,
  title: undefined,
  titleStyle: undefined,
  activeTitleStyle: undefined
};
exports.default = TabBarItemTitle;
