...
var _TabBarItemCenter = require('./TabBarItemCenter');

var _TabBarItemCenter2 = _interopRequireDefault(_TabBarItemCenter);
  ...
  _createClass(TabBarItem, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _Boxs.Box,
        {
          className: (0, _classnames2.default)(_Context2.default.prefixClass('tabs-bar-item'), {
            active: active
          }),
          onClick: t.props.onClick,
          flex: 1
        },
        _react2.default.createElement(_TabBarItemBadge2.default, _extends({}, item.props, { iconHeight: t.props.iconHeight, active: active }))
      );
    }
  }]);
...
TabBarItem.propTypes = {
  ...
  item: _propTypes2.default.element
};
TabBarItem.defaultProps = {
  className: undefined,
  item: undefined
};
exports.default = { TabBarItem: TabBarItem, TabBarItemCenter: _TabBarItemCenter2.default };
