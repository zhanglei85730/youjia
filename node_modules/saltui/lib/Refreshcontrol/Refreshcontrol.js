...
var RefreshControl = function (_React$Component) {
  ...
  _createClass(RefreshControl, [{
    ...
    value: function refreshText() {
      ...
      if (this.draging) {
        var text = this.y >= threshold ? afterPullLoadText : beforePullLoadText;
        return text;
      }
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          getScrollContainer = _props2.getScrollContainer,
          otherProps = _objectWithoutProperties(_props2, ['className', 'children', 'showRefreshing', 'refreshing', 'onRefresh', 'threshold', 'beforePullLoadText', 'afterPullLoadText', 'refreshingText', 'refreshIcon', 'showIcon', 'showText', 'getScrollContainer']);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          {
            ...
            className: (0, _classnames2.default)('needsclick', _Context2.default.prefixClass('refresh-control-area'))
          },
          children
        )
      );
