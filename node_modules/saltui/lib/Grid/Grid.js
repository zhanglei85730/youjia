    ...
    */
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        {
          className: (0, _classnames3.default)((0, _Context.prefixClass)('grid'), (_classnames = {}, _defineProperty(_classnames, className, !!className), _defineProperty(_classnames, (0, _Context.prefixClass)('no-line'), noLine), _defineProperty(_classnames, (0, _Context.prefixClass)('has-line'), !noLine), _defineProperty(_classnames, (0, _Context.prefixClass)('grid-touchable'), this.props.touchable), _classnames))
        },
...
Grid.propTypes = {
  ...
  // 单个格子的水平对其方式
  itemHAlign: _propTypes2.default.oneOf((0, _Boxs.ALIGN_VALUES)()),
  // 单个格子的垂直对其方式
  itemVAlign: _propTypes2.default.oneOf((0, _Boxs.ALIGN_VALUES)()),
  // 单元格是否可点击
