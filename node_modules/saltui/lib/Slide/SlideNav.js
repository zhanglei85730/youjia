    ...
    value: function render() {
      ...
      for (var i = 0; i < t.props.num; i++) {
        ...
        arr.push(_react2.default.createElement('div', {
          key: i,
          className: (0, _classnames3.default)((_classnames = {}, _defineProperty(_classnames, '' + prefixClass('M2 slide-nav-item'), true), _defineProperty(_classnames, 'active', i === t.props.active), _classnames))
        }));
      }
