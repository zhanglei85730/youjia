...
var renderRow = function renderRow(options) {
  ...
  return _react2.default.createElement(
    'div',
    {
      className: (0, _classnames3.default)(_Context2.default.prefixClass('table-row')),
      key: index
    },
  ...
  _createClass(Table, [{
    ...
    value: function renderEmptyContent() {
      ...
      return _react2.default.createElement(
        'div',
        {
          className: (0, _classnames3.default)(_Context2.default.prefixClass('table-empty-content H40 FC9 FAC')),
          style: {
            width: screenWidth
          }
        },
