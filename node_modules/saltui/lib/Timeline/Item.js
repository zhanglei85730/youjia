...
var genIcon = function genIcon(icon) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        {
          className: (0, _classnames3.default)(_Context2.default.prefixClass('timeline-item'), (_classnames = {}, _defineProperty(_classnames, t.props.className, !!t.props.className), _defineProperty(_classnames, 'active', t.props.active), _classnames)),
          key: t.props.index
        },
