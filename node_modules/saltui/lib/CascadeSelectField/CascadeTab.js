...
var CascadeTab = function (_React$Component) {
  _inherits(CascadeTab, _React$Component);

  function CascadeTab(props) {
    _classCallCheck(this, CascadeTab);

    var _this = _possibleConstructorReturn(this, (CascadeTab.__proto__ || Object.getPrototypeOf(CascadeTab)).call(this, props));
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _Tab2.default,
          {
            ...
            swipeable: false,
            speed: 1,
            onChange: function onChange(tabData) {
