...
var formatPlaceholder = function formatPlaceholder() {
  ...
  Object.keys(placeholder).forEach(function (key) {
    newPlaceholder[(0, _Utils.getLocale)(key)] = placeholder[key];
  });
...
var SearchBar = function (_React$Component) {
  ...
  _createClass(SearchBar, [{
    ...
    value: function render() {
      ...
      var t = this;
      var i18n = _locale2.default[(0, _Utils.getLocale)(t.props.locale)];
      var placeholder = t.props.placeholder;

      if ((typeof placeholder === 'undefined' ? 'undefined' : _typeof(placeholder)) === 'object' && placeholder !== null) {
        placeholder = formatPlaceholder(placeholder)[(0, _Utils.getLocale)(t.props.locale)];
      }
      ...
      return _react2.default.createElement(
        'div',
        {
          className: (0, _classnames4.default)(_Context2.default.prefixClass('search-bar'), (_classnames = {}, _defineProperty(_classnames, t.props.className, !!t.props.className), _defineProperty(_classnames, (0, _Utils.getLocale)(t.props.locale), !!(0, _Utils.getLocale)(t.props.locale)), _defineProperty(_classnames, 'active', t.state.isActive), _classnames))
        },
